...
class WalletPage extends StatefulWidget {
  final void Function(String)
      fetchWalletBalance; // Accept fetchWalletBalance function as parameter

  const WalletPage({Key? key, required this.fetchWalletBalance})
      : super(key: key);
...
class _WalletPageState extends State<WalletPage> {
  ...
  void fetchWallet() async {
    // Access the UserData provider to get the username
    String? username = Provider.of<UserData>(context, listen: false).username;

    // Check if username is not null
    if (username != null) {
      // Call the fetchWalletBalance function passed from the parent widget
      widget.fetchWalletBalance(username);
    }
  }
